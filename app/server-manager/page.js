                                ...
                                <dl className="mt-10 max-w-xl space-y-8 text-base leading-7 text-gray-300 lg:max-w-none">
                                    <div className="relative pl-9">
                                        <dt className="inline font-semibold text-white">
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="absolute -left-2 top-1 h-7 w-7 text-[#47E5C1]">
                                                <path fillRule="evenodd" d="M14.615 1.595a.75.75 0 0 1 .359.852L12.982 9.75h7.268a.75.75 0 0 1 .548 1.262l-10.5 11.25a.75.75 0 0 1-1.272-.71l1.992-7.302H3.75a.75.75 0 0 1-.548-1.262l10.5-11.25a.75.75 0 0 1 .913-.143Z" clipRule="evenodd" />
                                            </svg>
                                            Fast and Easy. 
                                        </dt>
                                        <dd className="inline ml-2">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Maiores impedit
                                    ...
                                    <div className="relative pl-9">
                                        ...
                                        <dd className="inline ml-2">Anim aute id magna aliqua ad ad non deserunt sunt. Qui irure qui lorem cupidatat
                                            commodo.</dd>
                                    </div>
                                </dl>
                                <a href="https://www.fantasytechs.com/rotlm"
