export default function aboutUS() {
  return (
    ...
    <section className="mt-48 px-6 sm:px-28 lg:mb-0 mb-36">
      ...
      Feel the excitement of joining a vibrant community of Railroads Online enthusiasts, where you can share ideas, strategies, and stories with fellow players. Collaborate with others to construct your ideal railroad empire and immerse yourself in this engaging world of creativity and teamwork.
      </p>
